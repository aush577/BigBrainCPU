# AG Report Generated 2020-11-29 12:15
This is a report about mp4compile generated for BigBrainCPU at 2020-11-29 12:15. The autograder used commit ``7c2a08746432`` as a starting point. If you have any questions about this report, please contact the TAs on Piazza.
### Quick Results:
 - Compilation: YES
...
Info: Running Quartus Prime Analysis & Synthesis
    ...
    Info: Processing started: Sun Nov 29 18:12:45 2020
...
Info (12128): Elaborating entity "pc_register" for hierarchy "datapath:dp|pc_register:pcreg" File: /job/student/hdl/datapath.sv Line: 188
Info (12128): Elaborating entity "regfile" for hierarchy "datapath:dp|regfile:rf" File: /job/student/hdl/datapath.sv Line: 201
Info (12128): Elaborating entity "ctrl_rom" for hierarchy "datapath:dp|ctrl_rom:ctrl_rom" File: /job/student/hdl/datapath.sv Line: 208
Info (12128): Elaborating entity "forwarding_unit" for hierarchy "datapath:dp|forwarding_unit:forw_unit" File: /job/student/hdl/datapath.sv Line: 257
Info (12128): Elaborating entity "cmp" for hierarchy "datapath:dp|cmp:cmp" File: /job/student/hdl/datapath.sv Line: 265
Info (12128): Elaborating entity "alu" for hierarchy "datapath:dp|alu:alu" File: /job/student/hdl/datapath.sv Line: 272
Info (12128): Elaborating entity "mem_forwarding_unit" for hierarchy "datapath:dp|mem_forwarding_unit:mem_forw_unit" File: /job/student/hdl/datapath.sv Line: 286
Info (12128): Elaborating entity "btb" for hierarchy "datapath:dp|btb:btb" File: /job/student/hdl/datapath.sv Line: 399
Info (12128): Elaborating entity "register" for hierarchy "datapath:dp|register:ifid_ireg" File: /job/student/hdl/datapath.sv Line: 419
Info (12128): Elaborating entity "register" for hierarchy "datapath:dp|register:ifid_pcreg" File: /job/student/hdl/datapath.sv Line: 428
Info (12128): Elaborating entity "register" for hierarchy "datapath:dp|register:ifid_btb_hit" File: /job/student/hdl/datapath.sv Line: 437
Info (12128): Elaborating entity "register" for hierarchy "datapath:dp|register:idex_ctrlreg" File: /job/student/hdl/datapath.sv Line: 484
...
Info (276014): Found 14 instances of uninferred RAM logic
    Info (276006): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:tag_array_0|data" is uninferred due to "logic" being set as ramstyle synthesis attribute File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:valid_array_0|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276006): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:tag_array_1|data" is uninferred due to "logic" being set as ramstyle synthesis attribute File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:valid_array_1|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:dirty_array_0|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:dirty_array_1|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276006): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:tag_array_0|data" is uninferred due to "logic" being set as ramstyle synthesis attribute File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:valid_array_0|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276006): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:tag_array_1|data" is uninferred due to "logic" being set as ramstyle synthesis attribute File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:valid_array_1|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:dirty_array_0|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:dirty_array_1|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:dcache|new_cache_datapath:datapath|new_array:lru_array|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
    Info (276004): RAM logic "new_cache:icache|new_cache_datapath:datapath|new_array:lru_array|data" is uninferred due to inappropriate RAM size File: /job/student/hdl/new_cache/new_array.sv Line: 27
...
Info (21057): Implemented 40630 device resources after synthesis - the final resource count might be different
    Info (21058): Implemented 67 input pins
    Info (21059): Implemented 98 output pins
    Info (21061): Implemented 40465 logic cells
Info: Quartus Prime Analysis & Synthesis was successful. 0 errors, 7 warnings
    Info: Peak virtual memory: 1334 megabytes
    Info: Processing ended: Sun Nov 29 18:15:00 2020
...
Info: Running Quartus Prime Shell
    ...
    Info: Intel and sold by Intel or its authorized distributors.  Please
    Info: refer to the applicable agreement for further details.
    Info: Processing started: Sun Nov 29 18:15:01 2020
...
Info: Quartus Prime Shell was successful. 0 errors, 0 warnings
    ...
    Info: Processing ended: Sun Nov 29 18:15:02 2020
...
# Top level modules:
# 	new_data_array
# End time: 18:15:03 on Nov 29,2020, Elapsed time: 0:00:00
# Errors: 0, Warnings: 0
...
# Top level modules:
# 	mp4_tb
# End time: 18:15:04 on Nov 29,2020, Elapsed time: 0:00:01
# Errors: 0, Warnings: 0
ModelSim> 
> 
...
# vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriaii_hssi_ver -L arriaii_pcie_hip_ver -L arriaii_ver -L rtl_work -L work -voptargs=""+acc"" mp4_tb 
# Start time: 18:15:04 on Nov 29,2020
# Loading sv_std.std
# Loading work.mp4_tb
# Loading work.tb_itf
...
> 
add wave *
VSIM 31> view structure
VSIM 32> # 
# <EOF>
# 0: RVMODEL NULL (Expected)
# End time: 18:15:04 on Nov 29,2020, Elapsed time: 0:00:00
# Errors: 0, Warnings: 5
...
---
Staff use: 5fc3e3fa992def9c51c727e4
